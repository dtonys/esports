...
exports.scrapeELSnew = function (req, res) {
  ...
  PythonShell.run('./scripts/match/scraper_match_esportlivescore.py',
    {
      mode: 'json',
...
exports.scrapeNewMatches = function(req, res) {
  console.log('Scraping sites for new matches!');


  PythonShell.run('./scripts/match/api_match_abios.py',
    {
      mode: 'json',
      args: ['50', '0']
    },
